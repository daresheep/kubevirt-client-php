...
/**
 * V1AccessCredentialSecretSource Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1AccessCredentialSecretSource implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.AccessCredentialSecretSource';
     ...
     * Sets secret_name
     *
     * @param string $secret_name SecretName represents the name of the secret in the VMI's namespace
     *
     * @return $this
     */
