...
/**
 * K8sIoApimachineryPkgApisMetaV1DeleteOptions Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class K8sIoApimachineryPkgApisMetaV1DeleteOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'k8s.io.apimachinery.pkg.apis.meta.v1.DeleteOptions';
    ...
    protected static $swaggerTypes = [
        ...
        'preconditions' => '\Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1Preconditions',
     ...
     * Sets dry_run
     *
     * @param string[] $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     *
     * @return $this
     */
     ...
     * Gets preconditions
     *
     * @return \Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1Preconditions
     */
     ...
     * Sets preconditions
     *
     * @param \Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1Preconditions $preconditions Must be fulfilled before a deletion is carried out. If not possible, a 409 Conflict status will be returned.
     *
     * @return $this
     */
