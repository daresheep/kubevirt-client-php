...
/**
 * V1VirtualMachineInstanceMigrationList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1VirtualMachineInstanceMigrationList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.VirtualMachineInstanceMigrationList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\Swagger\Client\Model\V1VirtualMachineInstanceMigration[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\V1VirtualMachineInstanceMigration[] $items items
     *
     * @return $this
     */
