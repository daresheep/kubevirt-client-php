...
class V1Probe implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'http_get' => '\Swagger\Client\Model\K8sIoApiCoreV1HTTPGetAction',
        'initial_delay_seconds' => 'int',
        'period_seconds' => 'int',
        'success_threshold' => 'int',
        'tcp_socket' => '\Swagger\Client\Model\K8sIoApiCoreV1TCPSocketAction',
        'timeout_seconds' => 'int'
    ];
     ...
     * Gets http_get
     *
     * @return \Swagger\Client\Model\K8sIoApiCoreV1HTTPGetAction
     */
     ...
     * Sets http_get
     *
     * @param \Swagger\Client\Model\K8sIoApiCoreV1HTTPGetAction $http_get HTTPGet specifies the http request to perform.
     *
     * @return $this
     */
     ...
     *
     * @param int $initial_delay_seconds Number of seconds after the VirtualMachineInstance has started before liveness probes are initiated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
     *
     * @return $this
     */
     ...
     * Gets tcp_socket
     *
     * @return \Swagger\Client\Model\K8sIoApiCoreV1TCPSocketAction
     */
     ...
     * Sets tcp_socket
     *
     * @param \Swagger\Client\Model\K8sIoApiCoreV1TCPSocketAction $tcp_socket TCPSocket specifies an action involving a TCP port. TCP hooks not yet supported
     *
     * @return $this
     */
