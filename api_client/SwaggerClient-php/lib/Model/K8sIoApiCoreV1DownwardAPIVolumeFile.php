...
/**
 * K8sIoApiCoreV1DownwardAPIVolumeFile Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class K8sIoApiCoreV1DownwardAPIVolumeFile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'k8s.io.api.core.v1.DownwardAPIVolumeFile';
    ...
    protected static $swaggerTypes = [
        'field_ref' => '\Swagger\Client\Model\K8sIoApiCoreV1ObjectFieldSelector',
        'mode' => 'int',
        'path' => 'string',
        'resource_field_ref' => '\Swagger\Client\Model\K8sIoApiCoreV1ResourceFieldSelector'
    ];
     ...
     * Gets field_ref
     *
     * @return \Swagger\Client\Model\K8sIoApiCoreV1ObjectFieldSelector
     */
     ...
     * Sets field_ref
     *
     * @param \Swagger\Client\Model\K8sIoApiCoreV1ObjectFieldSelector $field_ref Required: Selects a field of the pod: only annotations, labels, name and namespace are supported.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\K8sIoApiCoreV1ResourceFieldSelector
     */
     ...
     *
     * @param \Swagger\Client\Model\K8sIoApiCoreV1ResourceFieldSelector $resource_field_ref Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, requests.cpu and requests.memory) are currently supported.
     *
     * @return $this
     */
