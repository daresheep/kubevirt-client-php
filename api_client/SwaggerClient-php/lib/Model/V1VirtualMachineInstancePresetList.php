...
/**
 * V1VirtualMachineInstancePresetList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1VirtualMachineInstancePresetList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.VirtualMachineInstancePresetList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\Swagger\Client\Model\V1VirtualMachineInstancePreset[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\V1VirtualMachineInstancePreset[] $items items
     *
     * @return $this
     */
