...
/**
 * V1alpha1DataVolumeSourceHTTP Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1DataVolumeSourceHTTP implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.DataVolumeSourceHTTP';
     ...
     * Sets secret_ref
     *
     * @param string $secret_ref SecretRef A Secret reference, the secret should contain accessKeyId (user name) base64 encoded, and secretKey (password) also base64 encoded
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url URL is the URL of the http(s) endpoint
     *
     * @return $this
     */
