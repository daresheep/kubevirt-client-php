...
/**
 * V1VirtualMachineInstanceReplicaSetList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1VirtualMachineInstanceReplicaSetList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.VirtualMachineInstanceReplicaSetList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\Swagger\Client\Model\V1VirtualMachineInstanceReplicaSet[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\V1VirtualMachineInstanceReplicaSet[] $items items
     *
     * @return $this
     */
