...
/**
 * K8sIoApimachineryPkgApisMetaV1APIGroupList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class K8sIoApimachineryPkgApisMetaV1APIGroupList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'k8s.io.apimachinery.pkg.apis.meta.v1.APIGroupList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'groups' => '\Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1APIGroup[]',
        'kind' => 'string'
    ];
     ...
     * Sets groups
     *
     * @param \Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1APIGroup[] $groups groups is a list of APIGroup.
     *
     * @return $this
     */
