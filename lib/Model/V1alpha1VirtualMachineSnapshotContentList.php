...
/**
 * V1alpha1VirtualMachineSnapshotContentList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1VirtualMachineSnapshotContentList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.VirtualMachineSnapshotContentList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\Swagger\Client\Model\V1alpha1VirtualMachineSnapshotContent[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\V1alpha1VirtualMachineSnapshotContent[] $items items
     *
     * @return $this
     */
