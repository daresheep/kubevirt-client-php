...
/**
 * V1VirtualMachineInstanceList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1VirtualMachineInstanceList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.VirtualMachineInstanceList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\Swagger\Client\Model\V1VirtualMachineInstance[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\V1VirtualMachineInstance[] $items items
     *
     * @return $this
     */
