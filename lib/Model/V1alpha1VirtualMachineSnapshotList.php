...
/**
 * V1alpha1VirtualMachineSnapshotList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1VirtualMachineSnapshotList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.VirtualMachineSnapshotList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\Swagger\Client\Model\V1alpha1VirtualMachineSnapshot[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\V1alpha1VirtualMachineSnapshot[] $items items
     *
     * @return $this
     */
