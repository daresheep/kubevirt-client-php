...
/**
 * V1HostDevice Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1HostDevice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.HostDevice';
     ...
     * Sets device_name
     *
     * @param string $device_name DeviceName is the resource name of the host device exposed by a device plugin
     *
     * @return $this
     */
