...
/**
 * V1alpha1DataVolumeSourceImageIO Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1DataVolumeSourceImageIO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.DataVolumeSourceImageIO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['disk_id'] = isset($data['disk_id']) ? $data['disk_id'] : null;
     ...
     *
     * @param string $cert_config_map CertConfigMap provides a reference to the CA cert
     *
     * @return $this
     */
     ...
     * Sets disk_id
     *
     * @param string $disk_id DiskID provides id of a disk to be imported
     *
     * @return $this
     */
     ...
     * Sets secret_ref
     *
     * @param string $secret_ref SecretRef provides the secret reference needed to access the ovirt-engine
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url URL is the URL of the ovirt-engine
     *
     * @return $this
     */
