...
/**
 * K8sIoApiCoreV1NodeAffinity Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class K8sIoApiCoreV1NodeAffinity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'k8s.io.api.core.v1.NodeAffinity';
    ...
    protected static $swaggerTypes = [
        'preferred_during_scheduling_ignored_during_execution' => '\Swagger\Client\Model\K8sIoApiCoreV1PreferredSchedulingTerm[]',
        'required_during_scheduling_ignored_during_execution' => '\Swagger\Client\Model\K8sIoApiCoreV1NodeSelector'
    ];
     ...
     *
     * @return \Swagger\Client\Model\K8sIoApiCoreV1PreferredSchedulingTerm[]
     */
     ...
     *
     * @return \Swagger\Client\Model\K8sIoApiCoreV1NodeSelector
     */
     ...
     *
     * @param \Swagger\Client\Model\K8sIoApiCoreV1NodeSelector $required_during_scheduling_ignored_during_execution If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to an update), the system may or may not try to eventually evict the pod from its node.
     *
     * @return $this
     */
