...
/**
 * K8sIoApimachineryPkgApisMetaV1StatusDetails Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class K8sIoApimachineryPkgApisMetaV1StatusDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'k8s.io.apimachinery.pkg.apis.meta.v1.StatusDetails';
    ...
    protected static $swaggerTypes = [
        'causes' => '\Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1StatusCause[]',
        'group' => 'string',
        'kind' => 'string',
        'name' => 'string',
     ...
     * Gets causes
     *
     * @return \Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1StatusCause[]
     */
     ...
     * Sets causes
     *
     * @param \Swagger\Client\Model\K8sIoApimachineryPkgApisMetaV1StatusCause[] $causes The Causes array includes more details associated with the StatusReason failure. Not all StatusReasons may provide detailed causes.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind The kind attribute of the resource associated with the status StatusReason. On some operations may differ from the requested resource Kind. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     *
     * @return $this
     */
